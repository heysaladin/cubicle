...
const defaultTestimonials: Testimonial[] = [
  {
    quote: 'Partnering with Bestra illuminated the path we needed. Their organized approach allowed us to set priorities, make rapid decisions, and proceed with certainty.',
    name: 'Daniel',
    title: 'Head of Operations',
    company: 'Growth Company',
  },
  {
    quote: 'Bestra worked closely with our team at every stage. Their hands-on support and practical thinking made a real difference in how we execute and measure results.',
    name: 'Mark',
    title: 'Managing Director',
    company: 'Mid-Market Business',
  },
  {
    quote: 'The improvements we saw were tangible. From streamlined processes to clearer reporting, Bestra helped us build a stronger, more scalable foundation.',
    name: 'Sofia',
    title: 'CEO',
  ...
  return (
    <section className="section">
      <div className="base-container">
        ...
        {/* List */}
        <div className="border-t border-bestra-gray flex flex-col">
          {testimonials.map((t, i) => (
            <div key={i} className="flex flex-col md:flex-row gap-[4xl] py-[3xl] border-b border-bestra-gray">
              {t.imageSrc && (
